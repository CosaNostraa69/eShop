 ...
 */
final class Version20230718135842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, promotion_id INT NOT NULL, user_id INT NOT NULL, price INT NOT NULL, list LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', order_date DATETIME NOT NULL, INDEX IDX_F5299398139DF194 (promotion_id), INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category VARCHAR(50) NOT NULL, DROP category_id');
    }
}

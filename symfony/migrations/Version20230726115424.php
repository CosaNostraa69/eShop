 ...
 */
final class Version20230726115424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, user_id INT DEFAULT NULL, price INT NOT NULL, order_date DATETIME NOT NULL, used_code TINYINT(1) NOT NULL, INDEX IDX_F5299398139DF194 (promotion_id), INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
